...
function EventCard(props) {
  return (
    <>
        <Card isFooterBlurred className="w-[350px] h-[250px] col-span-12 sm:col-span-7">
            <CardHeader className="absolute z-10 top-1 flex-col items-start">
            <p className="text-tiny text-white/60 uppercase font-bold">{props.category}</p>
            ...
            <CardFooter className="absolute bg-black/40 bottom-0 z-10 border-t-1 border-default-600 white:border-default-100">
                <div className="flex flex-grow gap-2 items-center">
                    <div className="flex flex-col">
                        ...
                        <p className="text-tiny text-white/60">{props.date ? props.date.slice(0, 10) : ""}</p>
                    </div>
