  ...
  return (
    <div>
      <div className='flex text-dark'>
        ...
        />
        <div>
        <button onClick={() => setSelectedCategory('Concierto de Rock')} className="bg-pink text-light px-2 py-1 rounded-md mx-2">
          Rock
        </button>
        <button onClick={() => setSelectedCategory('Concierto de pop')} className="bg-pink text-light px-2 py-1 rounded-md mx-2">
          Pop
        </button>
        <button onClick={() => setSelectedCategory('Concierto de Rap')} className="bg-pink text-light px-2 py-1 rounded-md mx-2">
          Rap
        </button>
      </div>
      </div>
